                                                                             ...
                                                                             <div class="panel panel-Yellow ">
                                                                                   ...
                                                                                   Evoluciones
                                                                                        ...
                                                                                        <div align="center" >
                                                                                            ...
                                                                                            <button   class="btn btn-danger btn-circle btn-lg" id="btningresar" onclick=""  >
                    ...
                    <div class="panel panel-Red ">
                        ...
                        if(mysqli_num_rows($querymenu2) != 0){
                            ...
                            while ($validacion2=mysqli_fetch_array($querymenu2))
                            {
                                ...
                                echo "<h3><br/> Alergico :</h3><br/><h2> <b>".$validacion2["descripcion"].'</b></h2>';
                        ...
                        {
                            echo "<h3><br/> Alergico :<br/></h3> <h2><b>No hay Alergias </b></h2>";
                            $alergico = "0";
